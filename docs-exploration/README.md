...
- **[questions.md](questions.md)** (Updated: Sept 24, 2026) — Open design trade-offs, security considerations, and implementation ambiguities in warm-pool adoption, routing, and network policies.
