...
- **[questions.md](questions.md)** (Updated: Sept 22, 2026) — Open design trade-offs, security considerations, and implementation ambiguities in warm-pool adoption, routing, and network policies.
